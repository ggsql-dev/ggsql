...
VISUALISE AS PLOT
WITH line USING x = date, y = value, color = 'blue'
WITH point USING x = date, y = value, color = 'red', size = 30
SCALE x USING type = 'date'
...
VISUALISE AS PLOT
WITH line USING x = month, y = total_revenue, color = 'steelblue'
WITH point USING x = month, y = total_revenue, color = 'darkblue', size = 30
WITH line USING x = month, y = total_quantity_scaled, color = 'coral'
WITH point USING x = month, y = total_quantity_scaled, color = 'orangered', size = 30
SCALE x USING type = 'date'
...
SELECT x, y FROM 'data.csv'
VISUALISE AS PLOT
WITH point USING x = x, y = y, color = 'blue', size = 4
...
GROUP BY category
VISUALISE AS PLOT
WITH bar USING y = total, fill = category
COORD polar
...
WITH point USING x = month, y = total_revenue
SCALE x USING type = 'date'
...
VISUALISE AS PLOT
WITH bar USING x = category, y = total_revenue, fill = region
