...
DRAW point MAPPING date AS x, value AS y, 'red' AS color USING size := 30
SCALE x USING type = 'date'
...
DRAW point MAPPING month AS x, total_revenue AS y, 'darkblue' AS color USING size := 30
DRAW line MAPPING month AS x, total_quantity_scaled AS y, 'coral' AS color
DRAW point MAPPING month AS x, total_quantity_scaled AS y, 'orangered' AS color USING size := 30
SCALE x USING type = 'date'
...
SELECT x, y FROM 'data.csv'
VISUALISE AS PLOT
DRAW point MAPPING x AS x, y AS y, 'blue' AS color USING size := 4
