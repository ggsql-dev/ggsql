...
`linetype` defines the stroke pattern of lines, e.i. a succession of "on" and "off" areas of the line to make different stipple patterns. Linetype is most useful for [line](../../layer/line.qmd) and [path](../../layer/path.qmd) layers as a colourless way to differentiate between categories. 
