...
The `method => 'tls'` setting uses total least squares to compute the intercept $a$ and sloep $b$ of a straight line.
...
The perpendicular distances imply having measurement error in both $x$ and $y$.
